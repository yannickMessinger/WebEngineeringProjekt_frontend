...
export const CharacterChoice = () => {
  ...
  return (
    <div className={css.choosechar}>
      <div className={css.arrowleft} onClick={() => charChoiceHandlerPrev()}></div>
      <div
      ...
      >
        <Character swapi_id={returnCharacter().swapi_id} name={returnCharacter().name} img_path={returnCharacter().img_path} />
      </div>
      <div className={css.arrowright} onClick={() => charChoiceHandlerNext()}></div>
    </div>
  );
};
